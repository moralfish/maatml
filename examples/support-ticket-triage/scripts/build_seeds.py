...
TEMPLATES: dict[str, list[tuple[str, str, str, str]]] = {
    "billing": [
        (
            ...
            "Duplicate {plan} charge in {month}; refund requested",
            "p2",
        ),
        (
            ...
            "Renewal decline locked workspace despite updated card",
            "p1",
        ),
        (
            ...
            "Invoice {invoice} disputed against {month} usage",
            "p3",
        ),
        (
            ...
            "Requests switch to annual billing on {plan} plan",
            "p4",
        ),
    ],
    "access": [
        (
            ...
            "SSO certificate rotation blocks {team_name} team sign-in",
            "p1",
        ),
        (
            ...
            "Account locked after failed attempts; needs unlock",
            "p2",
        ),
        (
            ...
            "Requests {count} new seats for {team_name} workspace",
            "p3",
        ),
        (
            ...
            "Offboarding: revoke {product} access for departed member",
            "p3",
        ),
    ],
    "bug": [
        (
            ...
            "{product} export returns 500 since {month} release",
            "p1",
        ),
        (
            ...
            "{product} dashboard serves stale {month} data",
            "p2",
        ),
        (
            ...
            "{product} search indexing lags for recent records",
            "p2",
        ),
        (
            ...
            "{product} timestamps off by one hour for {team_name} office",
            "p3",
        ),
    ],
    "how_to": [
        (
            ...
            "Asks how to export {month} data from {product}",
            "p4",
        ),
        (
            ...
            "Asks recommended role setup for {count}-person team",
            "p4",
        ),
        (
            ...
            "Asks about automating recurring {plan} plan reports",
            "p4",
        ),
        (
            ...
            "Asks where to find {product} audit logs for {month}",
            "p3",
        ),
    ],
    "other": [
        (
            ...
            "bring it back?",
            "Feedback on {month} redesign; requests compact view",
            "p4",
        ),
        (
            "Partnership enquiry",
            ...
            "Partnership enquiry about {product} integration",
            "p4",
        ),
        (
            ...
            "Status page stayed green during {month} incident",
            "p3",
        ),
        (
            ...
            "Offers to participate in a customer case study",
            "p4",
        ),
    ],
}
